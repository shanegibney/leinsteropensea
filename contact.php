...
$subject = "Leinster Open Sea contact form message";
...
try
{
    ...
    $emailText = "You have a new message from the LOS contact form\n\n";
    ...
    // Send email
    mail('leinsteropenseaswim@gmail.com', $subject, $emailText, implode("\n", $headers));
